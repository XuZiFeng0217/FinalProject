 ...
 * @author zzz
 */
public class Z31 extends javax.swing.JPanel {
    ...
    private int selectedPieIndex = -1; // 鼠标点击是选中的Arc, -1为没有选中
     ...
     public Z31(JPanel userProcessContainer, UserAccount account, EcoSystem business) {
        initComponents();
            ...
            for(Order order : business.getOrderDirectory()){
                if(order.getCompany().getName().equals("SF")){
                    if(order.getDeliveryMan().getFirstName().equals("d1")){
                        ...
                        ad2++;
                    }else if(order.getDeliveryMan().getFirstName().equals("d3")){
                        ad3++;
                    }
                }
            }
...
//        frame.setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Brown: d2    Yellow: d1   Green: d3");
